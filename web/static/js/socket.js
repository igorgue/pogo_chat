...
function buildLayover(lay) {
  ...
  switch (lay) {
    ...
    case 'REPORT_SIGNTING':
      ...
      content.html('<div class="report-signting-data"><p>Select the pokemon you wish to report.</p><select class="what-pokemon" style="width: 100%;"></select><div class="show-pokemon"><h2></h2><hr><img src=""><div class="report-button">Report Sighting</div></div></div>')
